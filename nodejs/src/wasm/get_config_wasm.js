...
* @returns {string}
*/
module.exports.getConfigDeserializeInput = function(params) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(params, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.getConfigDeserializeInput(retptr, ptr0, len0);
...
* @returns {string}
*/
module.exports.getConfigTyped = function(params) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.getConfigTyped(retptr, addHeapObject(params));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
const path = require('path').join(__dirname, 'get_config_wasm_bg.wasm');
